...
double sigma3 = 4.262e12;	// cross section [fb] for pt > 10 GeV, as = 0.110
double sigma4 = 5.389e12;	// cross section [fb] for pt > 10 GeV, as = 0.130
double sigma5 = 4.664e12;	// cross section [fb] for pt > 10 GeV, as = 0.118
...
void pt1Norm() {
	...
	TH1D *hpt1_3 = new TH1D("hpt1_3","p_{T}(jet_{1}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{1}) [GeV];N_{exp}",50,10,110);
	TH1D *hpt1_4 = new TH1D("hpt1_4","p_{T}(jet_{1}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{1}) [GeV];N_{exp}",50,10,110);
	TH1D *hpt1_5 = new TH1D("hpt1_5","p_{T}(jet_{1}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{1}) [GeV];N_{exp}",50,10,110);
...
void pt2Norm() {
	...
	// histograms of distributions
	TH1D *hpt2_3 = new TH1D("hpt2_3","p_{T}(jet_{2}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{2}) [GeV];N_{exp}",50,10,110);
	TH1D *hpt2_4 = new TH1D("hpt2_4","p_{T}(jet_{2}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{2}) [GeV];N_{exp}",50,10,110);
	TH1D *hpt2_5 = new TH1D("hpt2_5","p_{T}(jet_{2}) - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;p_{T}(jet_{2}) [GeV];N_{exp}",50,10,110);
...
void QNorm() {
	...
	// histograms of distributions
	TH1D *hQ_3 = new TH1D("hQ_3","Q - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;Q [GeV];N_{exp}",50,10,110);
	TH1D *hQ_4 = new TH1D("hQ_4","Q - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;Q [GeV];N_{exp}",50,10,110);
	TH1D *hQ_5 = new TH1D("hQ_5","Q - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;Q [GeV];N_{exp}",50,10,110);
...
void m12Norm() {
	...
	// histograms of distributions
	TH1D *hm12_3 = new TH1D("hm12_3","m_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{12} [GeV];N_{exp}",40,0,240);
	TH1D *hm12_4 = new TH1D("hm12_4","m_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{12} [GeV];N_{exp}",40,0,240);
	TH1D *hm12_5 = new TH1D("hm12_5","m_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{12} [GeV];N_{exp}",40,0,240);
...
void mtotNorm() {
	...
	// histograms of distributions
	TH1D *hmtot_3 = new TH1D("hmtot_3","m_{TOT} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{TOT} [GeV];N_{exp}",48,0,240);
	TH1D *hmtot_4 = new TH1D("hmtot_4","m_{TOT} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{TOT} [GeV];N_{exp}",48,0,240);
	TH1D *hmtot_5 = new TH1D("hmtot_5","m_{TOT} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;m_{TOT} [GeV];N_{exp}",48,0,240);
...
void eta12Norm() {
	...
	// histograms of distributions
	TH1D *heta12_3 = new TH1D("heta12_3","#Delta#eta_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#eta_{12};N_{exp}",25,-2.5,2.5);
	TH1D *heta12_4 = new TH1D("heta12_4","#Delta#eta_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#eta_{12};N_{exp}",25,-2.5,2.5);
	TH1D *heta12_5 = new TH1D("heta12_5","#Delta#eta_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#eta_{12};N_{exp}",25,-2.5,2.5);
...
void phi12Norm() {
	...
	// histograms of distributions
	TH1D *hphi12_3 = new TH1D("hphi12_3","#Delta#phi_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#phi_{12};N_{exp}",25,0,3.5);
	TH1D *hphi12_4 = new TH1D("hphi12_4","#Delta#phi_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#phi_{12};N_{exp}",25,0,3.5);
	TH1D *hphi12_5 = new TH1D("hphi12_5","#Delta#phi_{12} - p_{T, min}(j) = 10 GeV, p_{T}(jet) > 20 GeV;#Delta#phi_{12};N_{exp}",25,0,3.5);
